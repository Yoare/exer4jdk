...
public class DynamicGenerator {
    ...
    public static void main(String[] args) {
        ...
        //2.会产生一个$Proxy0.class文件，这个文件就是动态生成的代理类文件。
        //相当于人家自动给你实现了一个代理类的class（而不用手动实现代理类）
    ...
    /*
        Java核心技术点之动态代理
        2017-03-25 ImportNew
        （点击上方公众号，可快速关注）

        来源：absfree，
        www.cnblogs.com/absfree/p/5392639.html
        如有好文章投稿，请点击 → 这里了解详情
